...
COMMANDS:
  ...
  screenshot [--name <s>]         Plain text screen dump (default)
    --png [--out <path>]            PNG image screenshot
    --ansi                          Text with ANSI escape codes
    --html [--out <path>]           HTML file
...
EXAMPLES:
  ...
  tu screenshot --png                  Visual screenshot for LLM vision
